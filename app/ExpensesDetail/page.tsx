            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex justify-between items-center">
                <button
                  ...
                  onClick={() =>
                    setCurrentMonthFrom(subMonths(currentMonthFrom, 1))
                  }
                >
                  {"<"}
                </button>
                ...
                <button
                  className="p-2 rounded-full hover:bg-gray-200"
                  onClick={() =>
                    setCurrentMonthFrom(addMonths(currentMonthFrom, 1))
                  }
                >
                  {">"}
                </button>
          ...
          <div className="container mx-auto py-8">
            ...
            <div className="flex">
              ...
              <div className="flex justify-between w-full space-x-2 mb-6">
                <button className="bg-[#CBFDB0] hover:bg-[#A7FF77] w-32 text-black px-4 py-2 shadow-lg rounded-xl">
                  <strong>Food</strong>
                </button>
                <button className="bg-[#FCFFB9] hover:bg-[#F8FF6F] w-32 text-black px-4 py-2 shadow-lg rounded-xl">
                  <strong>Groceries</strong>
                </button>
                <button className="bg-[#99E3EB] hover:bg-[#71DFEC] w-32 text-black px-4 py-2 shadow-lg rounded-xl">
                  <strong>Health</strong>
                </button>
                <button className="bg-[#F5A0A0] hover:bg-[#ED7A7A] w-32 text-black px-4 py-2 shadow-lg rounded-xl">
                  <strong>Electricity</strong>
                </button>
                <button className="bg-[#FBCE7A] hover:bg-[#FDC358] w-36 text-black px-4 py-2 shadow-lg rounded-xl">
                  <strong>Transportation</strong>
                </button>
                <button className="bg-[#DBB2FF] hover:bg-[#C587FC] w-36 text-black px-4 py-2 shadow-lg rounded-xl">
            ...
            <div className="flex justify-between items-center mt-4">
              <span className="text-sm text-[#22B786]">
                Showing 1 to 6 of 6 entries
              </span>
              <div className="flex space-x-2">
                <button className="border-2 border-[#22B786] hover:bg-[#22B786] text-gray-700 px-3 py-1 rounded-lg">
                  Previous
                </button>
                <button className="border-2 border-[#22B786] hover:bg-[#22B786] text-gray-700 px-3 py-1 rounded-lg">
                  1
